    ...
    if (profilePicFile) {
        ...
        reader.onload = (event) => {
            ...
            resumeContainer.innerHTML = `
                ...
                <div class="education">
                    <h2> Education </h2>
                     <p><strong> Graduate in: </strong> ${graduation}</p>
                     <p> <strong> Graduation Year: </strong>${graduateYear}</p> 
                     <p><strong> Intermediate in: </strong> ${inter}</p> 
                     <p><strong> Inter Year: </strong> ${interYear}</p> 
                </div>
                <div class="skills">
                    <h2>Skills</h2>
                    <p>${skills.map((skill) => `<li>${skill.trim()}</li>`).join("")}</p>
                </div>
                 <div class="experince">
                 ...
                 <div class="contact">
                    <h2> Contact Me </h2>
                     <p><strong> E-mail: </strong> ${emailTwo}</p>
                     <p><strong> Telephone </strong> ${cell}</p> 
                </div>
            `
