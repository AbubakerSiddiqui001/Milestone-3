...
form.addEventListener("submit", function (e) {
    ...
    if (profilePicFile) {
        ...
        reader.onload = function (event) {
            ...
            resumeContainer.innerHTML = "\n                <div class=\"profile\">\n                    <img src=\"".concat(profilePicURL, "\" alt=\"Profile Picture\" class=\"profile-pic\">\n                    <h2>").concat(name, "</h2>\n                    <p>").concat(email, "</p>\n                </div>\n                 <div class=\"personal-info\">\n                    <h2> Personal Information : </h2>\n                    <p><strong> Father Name: </strong> ").concat(fName, "</p>\n                    <p><strong> Date Of Birth: </strong> ").concat(date, "</p> \n                    <p><strong> Nationality: </strong> ").concat(nationality, "</p> \n                    <p><strong> Religion: </strong> ").concat(religion, "</p>\n                </div>\n                <div class=\"education\">\n                    <h2> Education </h2>\n                     <p><strong> Graduate in: </strong> ").concat(graduation, "</p>\n                     <p> <strong> Graduation Year: </strong>").concat(graduateYear, "</p> \n                     <p><strong> Intermediate in: </strong> ").concat(inter, "</p> \n                     <p><strong> Inter Year: </strong> ").concat(interYear, "</p> \n                </div>\n                <div class=\"skills\">\n                    <h2>Skills</h2>\n                    <p>").concat(skills.map(function (skill) { return "<li>".concat(skill.trim(), "</li>"); }).join(""), "</p>\n                </div>\n                 <div class=\"experince\">\n                    <h2>Work Experince </h2>\n                     <p>").concat(experince, "</p>\n                </div>\n                 <div class=\"contact\">\n                    <h2> Contact Me </h2>\n                     <p><strong> E-mail: </strong> ").concat(emailTwo, "</p>\n                     <p><strong> Telephone </strong> ").concat(cell, "</p> \n                </div>\n            ");
